...
public class EmpRegistationForm extends JFrame {

	
public	EmpRegistationForm ()
	{
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String v3=new String(pass.getPassword());
			...
			//	String v6=text5.getText();
				...
				try 
				{
					...
					int r=st.executeUpdate("insert into p values('"+v1+"','"+v2+"','"+v3+"','"+v4+"','"+v5+"')");
